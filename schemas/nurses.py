...
class NurseBase(BaseModel):
    ...
    continuous_care_available:Optional[bool] = Field(False,description="Indicate whether the nurse is available for continuous services")
...
class NurseUpdate(BaseModel):
    ...
    continuous_care_available: Optional[bool] = None
